...
- **Style theme: Dark, Elegant, Professional**
  ...
  - Overall vibe: enterprise-grade fintech — think Bloomberg Terminal meets modern SaaS, not startup-playful
  - No emojis anywhere in the UI — icons only (lucide-react), text labels, no decorative emoji
